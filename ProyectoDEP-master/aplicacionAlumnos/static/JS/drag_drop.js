...
const archivos = document.getElementById('input-file');
...
dropArea.addEventListener("dragleave" , (e) => {
    e.preventDefault();
    dropArea.classList.remove("active");
    dragText.textContent = "Arrastra y suelta tus archivos";
...
// archivos.addEventListener('load', (e) => {
//     console.log('Cargó un archivo');
//     // reiniciarPreview();
//     // showFiles(archivos.files);
// })
